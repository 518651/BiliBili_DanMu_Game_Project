...
void connectToDanmuServer(WebSocket*& ws, const string& room_id) {
    ...
    std::cout << DanMu_Data_.DanMu_Post.append(reinterpret_cast<const char*>(serializePack(rcv_buffer, rcv_buffer_ser, rcv_len))) << endl;
    delete[] msg;
}
